...
<div class="books-overview-card">
  <div class="overview-chart">
    <div class="overview-donut" style="background: conic-gradient(<?php echo e($donutBackground); ?>);">
      <div class="overview-donut-inner">
        <div class="overview-total"><?php echo e(number_format($books->count())); ?></div>
      ...
      <?php $__currentLoopData = [
        ...
        <div class="overview-item">
          <div style="display:flex; align-items:center; gap:12px;">
            <span class="overview-dot <?php echo e($item['color']); ?>"></span>
            <div class="overview-item-label"><?php echo e($item['label']); ?></div>
          </div>
          <div class="overview-item-value"><strong><?php echo e(number_format($item['count'])); ?></strong> <span>(<?php echo e($item['pct']); ?>%)</span></div>
        </div>
...
<?php /**PATH C:\laragon\www\LIBRARY-MANAGEMENT-SYSTEM\resources\views/components/books-overview-card.blade.php ENDPATH**/ ?>