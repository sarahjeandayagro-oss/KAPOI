<?php $__env->startSection('title', 'Panabo City Library - Staff Portal'); ?>
...
<?php $__env->startSection('content'); ?>
  ...
  <?php if(session('visitor_barcode')): ?>
    <?php
      $visitorPass = session('visitor_barcode');
    ?>
    <?php $__env->startComponent('components.card', ['title' => 'Visitor Barcode Generated', 'subtitle' => 'Give this pass to the visitor']); ?>
      <div class="pass-card">
        <div>
          <div class="pass-name"><?php echo e($visitorPass['full_name']); ?></div>
          <div class="text-muted"><?php echo e($visitorPass['school']); ?> · <?php echo e($visitorPass['created_at']); ?></div>
        </div>
        <div class="pass-code"><?php echo e($visitorPass['barcode_id']); ?></div>
      </div>
  ...
  <?php endif; ?>
   ...
   <section id="panel-dashboard" class="panel active dashboard-stats-section">
    <div class="stats-grid">
      ...
      <?php echo $__env->make('components.stat-card', ['label' => 'Total Visitors (June)', 'value' => $totalVisitorsThisMonth ?? 0, 'change' => 'This month', 'tone' => 'brown', 'icon' => '👣'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
    ...
    <div class="staff-overview-row">
      <div class="card card-compact staff-books-overview" style="width:auto; min-width: 30%;">
        ...
        <div class="card-body" style="width: fit-content; min-width: 0;">
          <?php if (isset($component)) { $__componentOriginalbcb523749dc99de7666c0e207bf38d6a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbcb523749dc99de7666c0e207bf38d6a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.books-overview-card','data' => ['books' => $books]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('books-overview-card'); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalbcb523749dc99de7666c0e207bf38d6a)): ?>
<?php $attributes = $__attributesOriginalbcb523749dc99de7666c0e207bf38d6a; ?>
<?php unset($__attributesOriginalbcb523749dc99de7666c0e207bf38d6a); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalbcb523749dc99de7666c0e207bf38d6a)): ?>
<?php $component = $__componentOriginalbcb523749dc99de7666c0e207bf38d6a; ?>
<?php unset($__componentOriginalbcb523749dc99de7666c0e207bf38d6a); ?>
<?php endif; ?>
        </div>
      </div>

      <?php $__env->startComponent('components.card', ['title' => 'Gender Distribution']); ?>
        <div style="display: flex; gap: 20px; align-items: center;">
          <div>
            <div style="font-size: 24px; font-weight: 700; color: var(--text);"><?php echo e($femalePct ?? 0); ?>%</div>
            <div style="font-size: 12px; color: var(--muted);">Female (<?php echo e($femaleCount ?? 0); ?>)</div>
          </div>
          <div style="flex: 1; height: 8px; background: var(--border); border-radius: 4px; overflow: hidden;">
            <div style="height: 100%; width: <?php echo e($femalePct ?? 0); ?>%; background: #ec4899;"></div>
          </div>
        </div>
        <div style="display: flex; gap: 20px; align-items: center; margin-top: 16px;">
          <div>
            <div style="font-size: 24px; font-weight: 700; color: var(--text);"><?php echo e($malePct ?? 0); ?>%</div>
            <div style="font-size: 12px; color: var(--muted);">Male (<?php echo e($maleCount ?? 0); ?>)</div>
          </div>
          <div style="flex: 1; height: 8px; background: var(--border); border-radius: 4px; overflow: hidden;">
            <div style="height: 100%; width: <?php echo e($malePct ?? 0); ?>%; background: #3b82f6;"></div>
          </div>
        </div>
      <?php echo $__env->renderComponent(); ?>
    </div>
    ...
    <div class="staff-activity-row">
          ...
          <div class="activity-list" style="gap:8px;">
            <?php $__empty_1 = true; $__currentLoopData = $recentActivity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <div class="activity-item">
                <div class="activity-dot <?php echo e($activity->type === 'borrow' ? 'blue' : ($activity->type === 'entry' ? 'green' : 'gold')); ?>">
      ...
      <?php $__env->startComponent('components.card', ['title' => 'Recent Borrowings', 'subtitle' => 'Latest book issues on file']); ?>
        <div class="recent-borrowings-list">
          <?php $__empty_1 = true; $__currentLoopData = $recentBorrowings ?? collect(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $borrow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="recent-borrowing-item" style="display:flex; align-items:center; gap:12px;">
              ...
              <div style="flex:1; min-width:0;">
                <div class="recent-borrowing-book" style="font-weight:700; color:#0f172a;"><?php echo e($borrow->title ?? 'Unknown'); ?></div>
                <div class="recent-borrowing-meta" style="margin-top:4px; color:#6b7280;"><?php echo e($borrow->borrower_name ?? $borrow->member_name ?? 'Member'); ?></div>
              </div>
              <div class="recent-borrowing-status" style="white-space:nowrap; text-align:right;">
                <?php echo e($borrow->borrower_name ?? $borrow->member_name ?? $borrow->barcode_id ?? '—'); ?>
  ...
  <section id="panel-users" class="panel">
    <?php $__env->startComponent('components.card', ['title' => 'User Management', 'subtitle' => 'All users, verification and barcode actions']); ?>
      <table>
        ...
        <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $allUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
              <td><?php echo e($userRow->user_id); ?></td>
              <td><?php echo e($userRow->name); ?><br><span class="text-muted"><?php echo e($userRow->email); ?></span></td>
              <td><?php echo e($userRow->barcode_id ?? '—'); ?></td>
              <td><?php echo e(ucfirst($userRow->role)); ?></td>
              <td><span class="status-chip <?php echo e($userRow->status === 'approved' ? 'approved' : ($userRow->status === 'rejected' ? 'danger' : 'pending')); ?>"><?php echo e(ucfirst($userRow->status ?? 'pending')); ?></span></td>
              <td><?php echo e($userRow->status === 'rejected' ? ($userRow->rejection_reason ?? 'No reason provided.') : '—'); ?></td>
              <td><?php echo e($userRow->updated_at ? \Carbon\Carbon::parse($userRow->updated_at)->format('M d, Y h:i A') : 'N/A'); ?></td>
            </tr>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
  ...
  <section id="panel-verify" class="panel">
    <?php $__env->startComponent('components.card', ['title' => 'Pending Account Verifications', 'subtitle' => 'Student, researcher, and visitor accounts waiting for approval']); ?>
      <table>
        ...
        <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $pendingUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pendingUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
              ...
              <td><?php echo e($pendingUser->school ?? 'N/A'); ?></td>
              ...
              <td>
                <div style="display:flex; gap:8px; flex-wrap:wrap; align-items:center;">
                  <form method="POST" action="<?php echo e(route('admin.verify-researcher')); ?>" class="verify-form">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="lookup" value="<?php echo e($pendingUser->user_id ?? $pendingUser->email ?? $pendingUser->id); ?>">
    ...
    <?php $__env->startComponent('components.card', ['title' => 'Rejected Account Verifications', 'subtitle' => 'Rejected accounts and their rejection reasons']); ?>
      <table>
  ...
  <section id="panel-verified" class="panel">
    <?php $__env->startComponent('components.card', ['title' => 'Recently Verified Accounts', 'subtitle' => 'Approved accounts now visible immediately on staff dashboard']); ?>
      <table>
          ...
          <?php $__empty_1 = true; $__currentLoopData = $verifiedUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $verifiedUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
             <!-- <td><?php echo e($verifiedUser->user_id); ?></td> -->
              ...
              <td><?php echo e(ucfirst($verifiedUser->role)); ?></td>
  ...
  <?php $__env->startPush('scripts'); ?>
    ...
    <script>
      ...
      document.addEventListener('DOMContentLoaded', function() {
        ...
        if (<?php echo e(session('borrow_popup') || session('return_popup') ? 'true' : 'false'); ?>) {
          showBorrowModal();
        }
  ...
  <section id="panel-barcodes" class="panel">
    <div class="grid-2">
      <?php $__env->startComponent('components.card', ['title' => 'Create Available Barcode', 'subtitle' => 'Add a new unused barcode to the pool']); ?>
        <form method="POST" action="<?php echo e(route('admin.available-barcodes.store')); ?>" style="display:flex; gap:10px; flex-wrap:wrap; align-items:end;">
          <?php echo csrf_field(); ?>
      ...
      <?php $__env->startComponent('components.card', ['title' => 'Available Barcode Pool', 'subtitle' => 'Pre-generated barcodes waiting for assignment']); ?>
        <table>
              ...
              <tr>
                ...
                <td>
                  <div style="display:flex; gap:8px; flex-wrap:wrap;">
                    <form method="POST" action="<?php echo e(route('admin.available-barcodes.update', $barcode->id)); ?>" style="display:flex; gap:8px; align-items:center; flex-wrap:wrap;">
                      <?php echo csrf_field(); ?>
                      <input type="text" name="barcode_id" value="<?php echo e($barcode->barcode_id); ?>" style="width:140px;" required>
                      <button class="btn-secondary" type="submit">Update</button>
                    </form>
                    <form method="POST" action="<?php echo e(route('admin.available-barcodes.delete', $barcode->id)); ?>">
                      <?php echo csrf_field(); ?>
  ...
  <section id="panel-books" class="panel">
    <?php $__env->startComponent('components.card', ['title' => 'Book Collection (OPAC)', 'subtitle' => 'Search, add, edit and archive books']); ?>
      <div style="display:flex; gap:12px; margin-bottom:12px; align-items:flex-start;">
        <form id="book-add-form" method="POST" action="<?php echo e(route('admin.books.add')); ?>" enctype="multipart/form-data" style="flex:1; display:grid; grid-template-columns:repeat(2,1fr); gap:8px;">
          <?php echo csrf_field(); ?>
        ...
        <div style="width:320px;">
          ...
          <a href="<?php echo e(route('barcode.printer')); ?>" class="btn-primary" style="display:block; margin-top:8px; text-align:center; text-decoration:none; padding:10px; border-radius:6px; font-size:13px;">🖨️ Print Barcodes</a>
        </div>
      </div>
      ...
      <table>
        ...
        <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
              <td><code><?php echo e($book->barcode ?? 'N/A'); ?></code></td>
              <td><?php echo e($book->accession_number); ?></td>
              <td><?php echo e($book->title); ?></td>
              <td><?php echo e($book->author); ?></td>
              <td><?php echo e($book->available ?? 0); ?></td>
              <td><span class="status-chip"><?php echo e($book->status ?? 'Available'); ?></span></td>
              <td style="display:flex; gap:8px;">
                <form method="POST" action="<?php echo e(route('admin.books.update', $book->id)); ?>" enctype="multipart/form-data" style="display:inline-block;">
                  <?php echo csrf_field(); ?>
                  ...
                  <input type="hidden" name="copies" value="<?php echo e($book->copies ?? 1); ?>">
                  <input type="hidden" name="available" value="<?php echo e($book->available ?? 0); ?>">
                  <button class="btn-sm" type="submit">Quick Edit</button>
                </form>
                <form method="POST" action="<?php echo e(route('admin.books.delete', $book->id)); ?>">
                  <?php echo csrf_field(); ?>
  ...
  <section id="panel-book-management" class="panel">
    <?php $__env->startComponent('components.card', ['title' => 'Book Management', 'subtitle' => 'All books currently in the system']); ?>
      <div style="display:grid; gap:16px;">
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fit,minmax(140px,1fr)); gap:10px;">
          <?php $__currentLoopData = $transactionSummary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div style="padding:12px; border:1px solid #e2e8f0; border-radius:12px; background:#f8fafc;">
              <div style="font-size:11px; text-transform:uppercase; color:#64748b; font-weight:700;"><?php echo e($label); ?></div>
              <div style="font-size:22px; font-weight:800; color:#0f172a; margin-top:6px;"><?php echo e($count); ?></div>
            </div>
        ...
        <div style="overflow-x:auto;">
          <table>
            ...
            <tbody>
              <?php $__empty_1 = true; $__currentLoopData = $bookTransactionFeed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                  <td><?php echo e(\Carbon\Carbon::parse($entry['created_at'])->format('M d, Y h:i A')); ?></td>
                  <td><span style="display:inline-flex; padding:4px 10px; border-radius:999px; background:#e0f2fe; color:#0f766e; font-size:11px; font-weight:700;"><?php echo e($entry['event']); ?></span></td>
                  <td><?php echo e($entry['user_name']); ?></td>
                  <td><?php echo e($entry['book_title']); ?></td>
        ...
        <table>
          ...
          <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <tr>
                <td><code><?php echo e($book->barcode ?? 'N/A'); ?></code></td>
                <td><?php echo e($book->accession_number ?? 'N/A'); ?></td>
                <td><?php echo e($book->title ?? 'Unknown Title'); ?></td>
                <td><?php echo e($book->author ?? 'Unknown'); ?></td>
                <td><?php echo e($book->available ?? 0); ?></td>
                <td><span class="status-chip"><?php echo e($book->status ?? 'Available'); ?></span></td>
              </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
  ...
  <section id="panel-borrowing" class="panel">
    <?php $__env->startComponent('components.card', ['title' => 'Borrow / Return', 'subtitle' => 'Process borrow and returns by barcode']); ?>
      <div style="display:grid; gap:16px; margin-bottom:12px;">
        <?php if($errors->has('borrow_error')): ?>
          <div class="alert danger"><?php echo e($errors->first('borrow_error')); ?></div>
        <?php endif; ?>
        <form method="POST" action="<?php echo e(route('staff.borrow-by-barcode')); ?>" style="display:grid; gap:12px;">
          <?php echo csrf_field(); ?>
        ...
        <div>
          ...
          <table>
            ...
            <tbody>
              <?php $__empty_1 = true; $__currentLoopData = $borrowings->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                  <td><?php echo e($b->title ?? 'Unknown title'); ?></td>
                  <td><?php echo e($b->borrower_name ?? $b->barcode_id); ?></td>
                  <td><?php echo e(\Carbon\Carbon::parse($b->borrow_date)->format('M d, Y')); ?></td>
                  <td>
                    <?php if(!empty($b->due_date)): ?>
                      <?php echo e(\Carbon\Carbon::parse($b->due_date)->format('M d, Y')); ?>
                  ...
                  <td>
                    ...
                    <?php elseif($b->status === 'Due'): ?>
                      <span class="status-chip overdue">Due</span>
                    <?php else: ?>
                      <span class="status-chip pending"><?php echo e(ucfirst($b->status ?? 'Pending')); ?></span>
                    <?php endif; ?>
                  </td>
                  <td>
                    <?php if(empty($b->is_dummy) && $b->status !== 'Returned'): ?>
                      <div style="display:grid; gap:8px;">
                        <form method="POST" action="<?php echo e(route('admin.borrowings.return', $b->id)); ?>">
                          <?php echo csrf_field(); ?>
                      ...
                      ?>
                      <?php if($b->status !== 'Due' && (($due && ($due->isPast() || $due->isToday())) || $b->status === 'Borrowed')): ?>
                        <div style="display:flex; gap:8px;">
                          <form method="POST" action="<?php echo e(route('admin.borrowings.overdue', $b->id)); ?>">
                            <?php echo csrf_field(); ?>
                          ...
                          <form method="POST" action="<?php echo e(route('admin.borrowings.mark_due', $b->id)); ?>" class="mark-due-form">
                            <?php echo csrf_field(); ?>
                    ...
                    <?php elseif(empty($b->is_dummy) && $b->status === 'Returned'): ?>
                      <span class="status-chip returned">Returned</span>
                    <?php else: ?>
  ...
  <div class="borrow-modal-backdrop <?php echo e(session('borrow_popup') || session('return_popup') ? 'open' : ''); ?>" id="borrowModal" role="dialog" aria-modal="true" aria-labelledby="borrowModalTitle">
    <div class="borrow-modal">
      <div class="modal-head">
        <h2 id="borrowModalTitle"><?php echo e(session('return_popup') ? 'Book Return Recorded' : 'Welcome to Panabo City Library'); ?></h2>
      ...
      <div class="modal-body">
        <div class="photo" id="borrowPhoto">
          <?php if(session('book_cover')): ?>
            <img src="<?php echo e(session('book_cover')); ?>" alt="<?php echo e(session('book_title')); ?> cover">
          <?php else: ?>
        ...
        <div class="details">
          <div class="detail-row">
            ...
            <div class="detail-value"><?php echo e(session('borrower_full_name', 'Unknown')); ?></div>
          </div>
          <?php if(session('borrower_school')): ?>
            <div class="detail-row">
              <div class="detail-label">School</div>
              <div class="detail-value"><?php echo e(session('borrower_school')); ?></div>
            </div>
          <?php endif; ?>
          <div class="detail-row">
            <div class="detail-label">Book Title</div>
            <div class="detail-value"><?php echo e(session('book_title', 'Unknown Book')); ?></div>
          </div>
          <div class="detail-row">
            <div class="detail-label">Library ID</div>
            <div class="detail-value"><?php echo e(session('borrower_id', '-')); ?></div>
          </div>
          <div class="detail-row">
            <div class="detail-label">Date & Time</div>
            <div class="detail-value"><?php echo e(session('transaction_time', now()->format('F j, Y \a\t h:i A'))); ?></div>
          </div>
        </div>
      </div>
    </div>
 ...
 <!-- <section id="panel-attendance" class="panel">
    <div class="grid-1">
      <?php $__env->startComponent('components.card', ['title' => 'Attendance Summary']); ?>
        <table>
          <thead><tr><th>Name</th><th>ID</th><th>Total Logs</th></tr></thead>
          <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $staffAttendanceSummary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <tr>
                <td><?php echo e($staff->name); ?></td>
                <td><?php echo e($staff->user_id); ?></td>
                <td><?php echo e($staff->total_logs); ?></td>
              </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
-->
 ...
 <section id="panel-fines" class="panel">
  ...
  <div class="stats-grid" style="margin-bottom:18px;">
    ...
    <div class="card-body">
      <form action="<?php echo e(route('admin.financial-transactions.store')); ?>" method="POST" style="display:grid; grid-template-columns: repeat(3, 1fr); gap:12px;">
        <?php echo csrf_field(); ?>
 ...
 <div class="form-group" style="margin:0;">
       ...
       <input type="hidden" name="transaction_date" value="<?php echo e(now()->toDateString()); ?>">
   ...
   <div class="card-body" style="padding:0;">
     <table>
       ...
       <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $unpaidFineRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
           <tr>
             <td>
               <strong><?php echo e($row->user_name ?? $row->user_id ?? 'N/A'); ?></strong>
             </td>
             <td><?php echo e(preg_replace('/\s*\([^)]*day\/s\)/i', '', $row->description)); ?></td>
             ...
             <td><?php echo e(\Carbon\Carbon::parse($row->transaction_date)->format('M d, Y')); ?></td>
              <td>
                 <form action="<?php echo e(route('admin.financial-transactions.store')); ?>" method="POST" style="display:grid; gap:6px; min-width:220px;">
                  <?php echo csrf_field(); ?>
                  <input type="hidden" name="transaction_type" value="Fine">
                  ...
                  <input type="hidden" name="amount" value="<?php echo e($row->amount); ?>">
                  <input type="hidden" name="received_amount" value="<?php echo e($row->received_amount ?? 0); ?>">
                  <input type="hidden" name="transaction_date" value="<?php echo e(\Carbon\Carbon::parse($row->transaction_date)->format('Y-m-d')); ?>">
                  <select name="status" required>
 ...
 <div class="card">    <div class="card-header" style="background:#f0fdf4;">
    ...
    <div class="card-body" style="padding:0;">
      <table>
        ...
        <tbody>
             <?php $__empty_1 = true; $__currentLoopData = $paidFineRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
              <td>
                <?php
                ...
                ?>
                  ...
                  <strong><?php echo e($display); ?></strong>
                <?php else: ?>
                  <?php echo e($row->user_id ?? 'N/A'); ?>

                <?php endif; ?>
              </td>
<td><?php echo e(preg_replace('/\s*\([^)]*day\/s\)/i', '', $row->description)); ?></td>              <td style="font-weight:700;">PHP <?php echo e(number_format($row->amount, 2)); ?></td>
              <td>PHP <?php echo e(number_format((float) ($row->received_amount ?? 0), 2)); ?></td>
              <td>PHP <?php echo e(number_format((float) ($row->change_amount ?? 0), 2)); ?></td>
              <td><?php echo e(\Carbon\Carbon::parse($row->transaction_date)->format('M d, Y')); ?></td>
            </tr>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <tr>
  ...
  <script>
    (function () {
      ...
      const initialPanel = '<?php echo e(session('active_panel', 'dashboard')); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LIBRARY-MANAGEMENT-SYSTEM\resources\views/staff-dashboard.blade.php ENDPATH**/ ?>