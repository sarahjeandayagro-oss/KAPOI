  ...
  <body>
      ...
      <div class="shell">
          <header class="topbar">
              ...
              <div class="logo">
                  <img src="<?php echo e(asset('images/library logos.jpg')); ?>" alt="Panabo City Library Logo"
              ...
              <div class="top-actions">
                  ...
                  <a href="<?php echo e(route('login')); ?>" class="btn primary">Back to Login</a>
              </div>
          </header>
                      ...
                      <table class="visitors">
                          ...
                          <tbody id="recentVisitorsBody">
                              <?php $__empty_1 = true; $__currentLoopData = $recentVisitors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visitor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                  <tr>
                                      <td>
                                          <div class="name-cell"><?php echo e($visitor['name']); ?></div>
                                          <div class="muted"><?php echo e($visitor['school']); ?></div>
                                      </td>
                                      <td><?php echo e($visitor['barcode_id']); ?></td>
                                      <td data-entry-timestamp="<?php echo e($visitor['entry_timestamp']); ?>">
                                          <?php echo e($visitor['entry_time']); ?></td>
                                  </tr>
      ...
      `).join('');
          ...
          async function submitScan() {
              ...
              try {
                  const response = await fetch('<?php echo e(route('entrance.portal.scan')); ?>', {
                      method: 'POST',
                      headers: {
      ...
      `;
          ...
          async function performSearch() {
              ...
              try {
                  const response = await fetch('<?php echo e(route('entrance.portal.search')); ?>?query=' + encodeURIComponent(
                      query));
                  if (!response.ok) {
                      return clearSearchResults();
                  }
...
<?php /**PATH C:\laragon\www\LIBRARY-MANAGEMENT-SYSTEM\resources\views/entrance-portal.blade.php ENDPATH**/ ?>