...
<body>
  <div class="card">
    ...
    <?php if(auth()->check() && auth()->user()->email): ?>
      <p style="margin-top:-8px; margin-bottom:18px; font-weight:600; color:#1f2937;">Code sent to: <span style="word-break:break-word;"><?php echo e(auth()->user()->email); ?></span></p>
    <?php endif; ?>
    <?php if($errors->any()): ?>
    ...
    <?php endif; ?>
    <form method="POST" action="<?php echo e(route('email.verify')); ?>">
      <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\LIBRARY-MANAGEMENT-SYSTEM\resources\views/email-verify.blade.php ENDPATH**/ ?>