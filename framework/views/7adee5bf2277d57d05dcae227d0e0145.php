...
<div class="main-wrapper">
    ...
    <div class="right-panel">
        ...
        <div id="credentialsPanel">
            ...
            <a
                class="btn-scan"
                href="<?php echo e(route('entrance.portal')); ?>"
                style="
                    margin-top: 12px;
                    text-decoration: none;
                "
            ...
            <a
                class="btn-scan"
                href="<?php echo e(route('opac.index')); ?>"
                style="
                    margin-top: 12px;
                    text-decoration: none;
                "
        ...
        >
            ...
            <button
                class="btn-primary"
                onclick="window.location.href='<?php echo e(route('entrance.portal')); ?>'"
                style="
                    width: 220px;
                    margin-top: 0;
                "
...
<script src="<?php echo e(asset('login-script.js')); ?>"></script>
...
<?php /**PATH C:\laragon\www\LIBRARY-MANAGEMENT-SYSTEM\resources\views/login.blade.php ENDPATH**/ ?>