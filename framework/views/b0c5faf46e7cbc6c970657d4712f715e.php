<?php $__env->startSection('title', 'Panabo City Library - Researcher Portal'); ?>
...
<?php $__env->startSection('content'); ?>
  ...
  <section id="panel-dashboard" class="panel active">
    <div class="grid-3">
      <?php echo $__env->make('components.stat-card', ['label' => 'Proposals Submitted', 'value' => $proposalCount, 'change' => 'Active submissions'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      <?php echo $__env->make('components.stat-card', ['label' => 'Approved Projects', 'value' => $proposals->where('status', 'Approved')->count(), 'change' => 'For tracking'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      <?php echo $__env->make('components.stat-card', ['label' => 'Research Funds', 'value' => 'PHP ' . number_format(100000), 'change' => 'Allocated grant'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>

    <?php $__env->startComponent('components.card', ['title' => 'Proposal Overview', 'subtitle' => 'Research work status']); ?>
      <table>
        <thead><tr><th>Title</th><th>Status</th><th>Deadline</th></tr></thead>
        <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $proposals->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
              <td><?php echo e($proposal->title ?? 'Untitled Proposal'); ?></td>
              <td><span class="status-chip <?php echo e(($proposal->status ?? 'Pending') === 'Approved' ? 'approved' : 'pending'); ?>"><?php echo e($proposal->status ?? 'Pending'); ?></span></td>
              <td><?php echo e(isset($proposal->deadline) ? \Carbon\Carbon::parse($proposal->deadline)->format('M d, Y') : 'N/A'); ?></td>
            </tr>
  ...
  <section id="panel-submit" class="panel">
    <div class="grid-1">
      ...
      <?php $__env->startComponent('components.card', ['title' => 'Proposal Entry Form Data']); ?>
        <form id="proposalForm" action="<?php echo e(route('proposal.submit')); ?>" method="POST" enctype="multipart/form-data" onsubmit="handleFormSubmission(event)">
          <?php echo csrf_field(); ?>
  ...
  <section id="panel-proposals" class="panel">
    <?php $__env->startComponent('components.card', ['title' => 'My Proposals']); ?>
      <table>
        ...
        <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $proposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
              <td><?php echo e($proposal->title ?? 'Untitled Proposal'); ?></td>
              <td><span class="status-chip <?php echo e(($proposal->status ?? 'Pending') === 'Approved' ? 'approved' : 'pending'); ?>"><?php echo e($proposal->status ?? 'Pending'); ?></span></td>
              <td>PHP <?php echo e(number_format($proposal->budget ?? 0, 2)); ?></td>
            </tr>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <tr><td colspan="3">No proposals yet.</td></tr>
          <?php endif; ?>
  ...
  <section id="panel-notifications" class="panel">
    <?php $__env->startComponent('components.card', ['title' => 'Notifications', 'subtitle' => 'Messages sent to your account']); ?>
        ...
        <table>
          ...
          <tbody>
            <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td><?php echo e($notification->data['message'] ?? $notification->data['title'] ?? 'Notification'); ?></td>
                <td><span class="status-chip <?php echo e($notification->read_at ? 'returned' : 'pending'); ?>"><?php echo e($notification->read_at ? 'Read' : 'Unread'); ?></span></td>
                <td><?php echo e(\Carbon\Carbon::parse($notification->created_at)->format('M d, Y h:i A')); ?></td>
              </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LIBRARY-MANAGEMENT-SYSTEM\resources\views/researcher-dashboard.blade.php ENDPATH**/ ?>