...
<body>
    ...
    <div class="filters-bar">
        ...
        <div
            ...
            id="resultsCount"
        >
            {{ $totalBooks }} materials in catalog
        </div>
    ...
    >
        ...
        @forelse($books as $book)
            ...
            <a
                ...
                href="{{ route('opac.book', ['id' => $book->id]) }}"
            >
                ...
                >
                    ...
                    <div class="card-cover">
                        ...
                        @if($book->cover_image)
                            ...
                            <img
                                src="{{ '/storage/' . ltrim($book->cover_image, '/') }}"
                                alt="{{ $book->title }}"
                                loading="lazy"
                            >
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-details">
                            ...
                            >
                                ...
                                <img
                                    src="{{ route('barcode.book.png', ['barcode' => $book->barcode]) }}"
    ...
    <footer class="opac-footer">
        ...
        Panabo City Library &copy; {{ date('Y') }}
        — Online Public Access Catalog
