          ...
          <div class="notif-dropdown-head">
            ...
            <div class="notif-head-right">
              <div class="notif-tabs" role="tablist">
                ...
                <button type="button" class="notif-tab" data-filter="unread">Unread ({{ $unreadNotificationCount }})</button>
              </div>
            ...
            <div class="notif-list">
              @if($notifications->count())
                @foreach($notifications as $note)
                  ...
                  @endphp
                  <div class="notif-item {{ $note->read_at ? 'notif-read' : 'notif-unread' }}" data-id="{{ $note->id }}" data-status="{{ $note->read_at ? 'read' : 'unread' }}" data-title="{{ e($titleText) }}" data-body="{{ e($bodyText) }}" data-time="{{ e($timeText) }}" data-full-time="{{ e($fullTime) }}">
...
@push('scripts')
  <script>
    (function(){
      ...
      const markAllReadUrl = '{{ route('notifications.read-all') }}';
